...
function loadProducts() {
                ...
                <div class="card" data-id="${product.id}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="rating">
                            ...
                            <input value="5" name="rate4" id="star16" type="radio">
                            <label for="star16"></label>
                            <input value="4" name="rate4" id="star17" type="radio">
                            <label for="star17"></label>
                            <input value="3" name="rate4" id="star18" type="radio" checked=""/>
                            <label for="star18"></label>
                            <input value="2" name="rate4" id="star19" type="radio">
                            <label for="star19"></label>
                            <input value="1" name="rate4" id="star20" type="radio">
    ...
    // Agregar evento para abrir el modal al hacer clic en el producto
    const productCards = document.querySelectorAll('.card');
    productCards.forEach(card => {
        card.addEventListener('click', function (event) {
            // Prevenir la acción de clic en el botón "Añadir al carrito" o las estrellas
            if (event.target.closest('.add-to-cart-btn') || event.target.closest('.star')) {
                return;
            }
